            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px;">
                <div class="card-header bg-white py-4 border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="card-title mb-0 fw-bold text-dark">Add New Knowledge Base</h4>
                            <p class="text-muted mb-0">Add descriptive text and keywords for AI context</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body px-5 pb-5">
                    ...
                    <form action="{{ route('user.knowledgeBase.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('company_id') <small class="text-danger mt-1 d-block">{{ $message }}</small> @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="title" class="form-control border-0 bg-light py-2" placeholder="e.g. Greeting Protocols" style="border-radius: 0 10px 10px 0;" required>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="position-relative">
                                    <textarea name="content" id="kbContent" class="form-control border-0 bg-light" rows="10" 
                                        placeholder="Paste the rules, procedures or information here..." 
                                        style="border-radius: 15px;" maxlength="5000" required></textarea>
                                    <div class="position-absolute bottom-0 end-0 p-2 text-muted small">
                                        <span id="charCount">0</span>/5000
                                    </div>
                                </div>
                                <small class="text-muted mt-1 d-block">This is the main information Gemini will use to evaluate calls.</small>
                            ...
                            <div class="col-12">
                                ...
                                <small class="text-muted mt-1 d-block">Adding keywords helps the search engine find this entry more accurately during analysis.</small>
                                @error('keywords') <small class="text-danger mt-1 d-block">{{ $message }}</small> @enderror
                            </div>
                            ...
                            <div class="col-12 mt-5">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    ...
                                    <button type="submit" class="btn btn-primary px-5 py-2 fw-bold" style="border-radius: 12px; transition: 0.3s;" id="submitBtn">
                                        <i class="fas fa-save me-2"></i> Save Knowledge Entry
                                    </button>
                                </div>
                            </div>
                        </div>
