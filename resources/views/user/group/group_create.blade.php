                ...
                <div class="card">
                    <div class="card-header border-0" style="background: linear-gradient(135deg, #efefef 0%, #eef2f6 100%)">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="mb-0 text-dark fw-semibold">Group
                                     Registration</h3>
                    ...
                    <div class="card-body p-4">
                        <form id="companyRegistrationForm" method="POST" action="{{ route('user.group_data.store') }}" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-section">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        <label for="company_policies" class="form-label">Group Policies:</label>
...
<textarea class="form-control" id="qna_pair_prompt" name="qna_pair_prompt" rows="4"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label for="gem_qna_pair_eval" class="form-label">GEM QnA Pair Evaluation:</label>
<textarea class="form-control" id="gem_qna_pair_eval" name="gem_qna_pair_eval" rows="6"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <label for="gpt_qna_pair_eval" class="form-label">GPT QnA Pair Evaluation:</label>
<textarea class="form-control" id="gpt_qna_pair_eval" name="gpt_qna_pair_eval" rows="6"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-primary px-4 py-2">
                                    <i class="bi bi-save me-2"></i>Register Group
                                </button>
                            </div>
                        </form>
                    </div>
