            ...
            <div class="col-md-12 col-lg-8 offset-lg-2">
                ...
                <div class="card shadow-sm" style="background-color: rgba(225, 240, 255, 0.3); border: 2px solid #0d6efd;">
                    ...
                    <div class="card-body p-4" style="background-color: rgba(240, 248, 255, 0.5);">
                        ...
                        <form action="{{ isset($agent) ? route('user.agent.update', $agent->id) : route('user.agent.store') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            @if (isset($agent))
                                @method('PUT')
                            @endif
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="agent_name" id="agent_name"
                                            ...
                                            value="{{ old('agent_name', $agent->agent_name ?? '') }}" placeholder="Enter agent name"
                                            required style="background-color: rgba(255, 255, 255, 0.7);">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" id="email"
                                            ...
                                            value="{{ old('email', $agent->email ?? '') }}" placeholder="Enter agent email" required
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone_number" id="phone_number"
                                            ...
                                            value="{{ old('phone_number', $agent->phone_number ?? '') }}" placeholder="Enter phone number" required
                                            style="background-color: rgba(255, 255, 255, 0.7);">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="company_id" id="company_id" 
                                        class="form-select {{ $errors->has('company_id') ? 'is-invalid' : '' }}" required
                                        style="background-color: rgba(255, 255, 255, 0.7);">
                                        ...
                                        @if(isset($agents) && count($agents))
                                            @foreach($agents[0]['agents'] as $agentOption)
                                                <option value="{{ $agentOption['id'] ?? $agentOption['agent_id'] }}" 
                                                    {{ old('supervisor_id', $agentData['supervisor_id'] ?? '') == ($agentOption['id'] ?? $agentOption['agent_id']) ? 'selected' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="3"
                                    placeholder="Enter description" style="background-color: rgba(255, 255, 255, 0.7);">{{ old('description', $agent->description ?? '') }}</textarea>
                            </div>
