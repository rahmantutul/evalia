            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                ...
                <li class="mx-2 welcome-text">
                    <h5 class="mb-0 fw-semibold text-truncate">
                        Hello, {{ session('user.full_name') ?? session('user.username') ?? 'Supervisor' }}!
                    </h5>
                </li>                   
            </ul>
                        ...
                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                            ...
                            <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                <h6 class="my-0 fw-medium text-dark fs-13">
                                    {{ session('user.full_name') ?? session('user.username') ?? 'Supervisor' }}
                                </h6>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        productButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Set session via AJAX, then redirect to supervisor dashboard
                ...
                .then(data => {
                    if (data.success) {
                        // Redirect to supervisor dashboard for supervisor
